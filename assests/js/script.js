...
function writePassword() {
  // this inputs the functions answer to the text area
  ...
  function generatePassword() {
    var passwordLength = prompt(
      "How long do you want your password? It has to be between 8-128 characters."
    );
    ...
    if (passwordLength < 8 || passwordLength > 128) {
      ...
      // This assigns variables to the questions
      var addNumber = prompt(
        "Do you want to add numbers to your password? Yes or No?"
      );
      var addSpecial = prompt(
        "Do you want to add a special symbol to your password? Yes or No?"
      );
      var addUpcase = prompt("Do you want uppercase letters? Yes or No?");
      var addLower = prompt("Do you want lowercase letters? Yes or No?");

      // List of strings that contain the possible characters
      ...
      for (var i = 0; i < passwordLength; i++) {
        randomP += finalP.charAt(Math.floor(Math.random() * passwordLength));
      }
      return randomP;
    }
  }
